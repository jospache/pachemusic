...
func main() {
	...
	router.StaticFile("/termos.html", "./site/termos.html")
	router.StaticFile("/cookies.html", "./site/cookies.html")
	router.StaticFile("/copyright.html", "./site/copyright.html")
	router.StaticFile("/contacto.html", "./site/contacto.html")
